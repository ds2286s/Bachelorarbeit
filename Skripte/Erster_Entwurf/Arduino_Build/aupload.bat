...
call C:\Users\Dennis\Desktop\ArduinoBatch\sketch_nov04a\agetpref.bat agetpref_internal
if not !errorlevel! == 0 (
    goto end
)
...
start !python!\python.exe C:\Users\Dennis\Desktop\ArduinoBatch\sketch_nov04a\PortReset.py %2
